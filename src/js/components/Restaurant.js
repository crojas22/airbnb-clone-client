...
import { FETCH_RESTAURANT_DATA } from "../type";
...
export default OnOffWithMount((
  ...
  return(
    <div>
      <Navigation/>
      <RestaurantMainPictures photos={listing.photos}/>
      <div className="container my-4">
        <div className="row">
          <div className="point-reference col-md-7 col-lg-6">
            <RestaurantHeader
              title={listing.title}
              simpleDescription={listing.simpleDescription}
              size={13}
            />
            <ReservationMobile />
              ...
              <div className="mr-xl-5">
                <div className="pb-4 mb-2">
                  ...
                  <div className="font-1 font-weight-light d-xl-none">
                    {
                      `Around $${listing.price} per person`
                    }
                  </div>
                </div>
                <div>
            ...
            <TitleParagraph title={<h5>About {listing.title}</h5>}
...
})(["v1/restaurant", "individualRestaurant", FETCH_RESTAURANT_DATA])